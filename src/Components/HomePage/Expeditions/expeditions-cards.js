        ...
        <div>
            ...
            <div className='flex flex-wrap justify-center gap-5 '>
                {Object.entries(expeditionData.expeditions).map((expedition,i) => (
                    ...
                    <motion.div variants={parentAnimate} initial='initial' whileHover='hover' whileInView='view' onClick={e=>{e.preventDefault();handleClick(expedition[0])}} transition={{delay:(i+0.01)/10, duration:0.5}} viewport={{once:true}} key={expedition.id} className="max-w-sm rounded overflow-hidden shadow-lg m-4 relative group" style={{ width: '100%', height: '500px' }}>
