...
const ExpeditionCard = () => {
    return (
        <div>
            <h1 className="text-center font-jomolhari font-bold text-4xl mb-8 ml-90 mt-10 text-yellow-400">Expeditions</h1>
            ...
            <div className='flex flex-wrap justify-center'>
                {expeditionData.map(expedition => (
                    <div key={expedition.id} className="max-w-sm rounded overflow-hidden shadow-lg m-4 relative group" style={{ width: '100%', height: '800px' }}>
                        ...
                        <div className="font-jomolhari font-bold text-3xl mb-2" style={{ position: 'absolute', zIndex: '1', color: '#FFD084', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', transition: 'all 0.3s ease' }}>{expedition.title}</div>
