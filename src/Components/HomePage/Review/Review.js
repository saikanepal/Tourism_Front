...
export default function Review() {
  return (
    <>
      <h1
        className="flex justify-center text-4xl font-
            ...
            <form className="space-y-6" action="#">
              <div>
                ...
                <input
                  ...
                  name="name"
                  id="name"
                  className="bg-[#EDEDED] border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:border-none focus:outline-none dark:placeholder-gray-400 dark:text-white"
                  placeholder="Name"
                  required
                />
              </div>
              ...
              <textarea
                id="message"
                rows="4"
                class="block p-2.5 w-full text-sm text-gray-900 bg-[#EDEDED] rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 focus:border-none focus:outline-none"
                placeholder="|"
              ></textarea>
